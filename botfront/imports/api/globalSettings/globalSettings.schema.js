...
export const privateSettingsSchema = new SimpleSchema({
    ...
    'webhooks.uploadVideoWebhook': { type: webhookSchema, optional: true },
    'webhooks.deleteVideoWebhook': { type: webhookSchema, optional: true },
    'webhooks.uploadTableWebhook': { type: webhookSchema, optional: true },
    'webhooks.deleteTableWebhook': { type: webhookSchema, optional: true },
...
export const publicSettingsSchema = new SimpleSchema({
    ...
    docUrl: { type: String, defaultValue: 'https://clai-docs.pemari.com' },
