...
export const chatWidgetSettingsSchema = new SimpleSchema({
    title: { type: String, optional: true, defaultValue: 'Clai' },
    ...
    closePayload: { type: String, optional: true, defaultValue: '/close' },
    widgetTitleColor: { type: String, optional: true },
    widgetSubtitleColor: { type: String, optional: true },
    ...
    tooltipBackgoundColor: { type: String, optional: true },
    tooltipTextColor: { type: String, optional: true },
    tooltipBorderColor: { type: String, optional: true },
    tooltipFontSize: { type: Number, defaultValue: 15, min: 10, max: 25 },
    tooltipBorderSize: { type: Number, defaultValue: 0, min: 0, max: 5 },
    ...
    disableClosePayload: {type: Boolean, optional: true},
    showMessageDate: { type: Boolean, optional: true },
    btncss: { type: String, optional: true },
    ...
    Widgetitlefont: {type: Number, defaultValue: 15, min: 10, max: 25},
    WidgetSubtitlefont: {type: Number, defaultValue: 12, min: 10, max: 25},
    AssistantconvFont: {type: Number, defaultValue: 15, min: 10, max: 25},
    UserconvFont: {type: Number, defaultValue: 15, min: 10, max: 25},
}, { strict: false });
...
export const ProjectsSchema = new SimpleSchema({
    ...
    currentlyRunningId: { type: Boolean, defaultValue: false },
}, { tracker: Tracker });
