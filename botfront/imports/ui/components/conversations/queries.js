...
// export const GET_SENTIMENT_IN_CONVERSATIONS = gql`
//     query retrieveSentimentInConversations($projectId: String!, $conversationId: String) {
//         sentimentInConversations(projectId: $projectId, $conversationId: String)
// }`;
