...
import sentimentAnalysis from '../../../api/graphql/conversations/queries/sentimentAnalysis.graphql';
...
const AnalyticsDashboard = ({ dashboard, onUpdateDashboard }, ref) => {
    ...
    const cardTypes = {
        ...
        sentimentAnalysis: {
            ...
            titleDescription: 'The number of user utterances classified as having a given intent.',
            queryParams: {
                envs, queryName: 'sentimentAnalysis', langs, intentTypeFilter: 'utterance',
            },
