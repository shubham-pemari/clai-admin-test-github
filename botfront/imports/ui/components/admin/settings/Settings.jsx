...
class Settings extends React.Component {
    ...
    renderMisc = () => {
        ...
        return (
            <>
                <Segment>
                    {/* <AutoField name='settings.private.bfApiHost' label='Clai API host' data-cy='docker-api-host' /> */}
                    {/* <AutoField name='settings.public.chitChatProjectId' label='Clai project Id' info='ID of project containing chitchat NLU training data' /> */}
