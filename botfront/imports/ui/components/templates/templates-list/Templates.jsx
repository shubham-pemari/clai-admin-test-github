    ...
    renderAddResponse = () => (
        ...
        >
            <Dropdown.Menu>
                ...
                <Dropdown.Item
                    text='Table'
                    onClick={() => this.setState({ newResponse: { open: true, type: 'TablePayload' } })}
                    data-cy='add-table-response'
                />
                <Dropdown.Item
                    text='Custom'
                ...
                <Dropdown.Item
                    text='Star Rating'
                    onClick={() => this.setState({ newResponse: { open: true, type: 'StarRatingPayload' } })}
                    data-cy='add-quickreply-response'
                />
                <Dropdown.Item
                    text='Feedback'
                    onClick={() => this.setState({ newResponse: { open: true, type: 'LikeDislikePayload' } })}
                    data-cy='add-quickreply-response'
                />
            </Dropdown.Menu>
        </Dropdown>
