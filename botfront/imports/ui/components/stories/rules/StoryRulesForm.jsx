...
class RulesForm extends AutoForm {
    ...
    getDefaultValue = (field) => {
        ...
        case 'url':
            return { partialMatch: false, regularExpression: false, path: '' };
        case 'queryString':
...
function StoryRulesForm({
    ...
    const TriggerSchema = new SimpleSchema({
        ...
        'url.$.partialMatch': { type: Boolean, defaultValue: false },
        'url.$.regularExpression': { type: Boolean, defaultValue: false },
                                        ...
                                        <ListItemField name='$'>
                                            <NestField name=''>
                                                ...
                                                <AutoField
                                                    ...
                                                    label='Match this page with regular expressions'
                                                />
                                            </NestField>
                                        </ListItemField>
                                    </ListField>
