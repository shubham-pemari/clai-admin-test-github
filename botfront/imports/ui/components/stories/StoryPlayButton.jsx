...
const StoryPlayButton = (props) => {
    ...
    const playStory = () => {
        ...
        // changeChatClosePayload(`/${getClosePayload()}`);
        refreshChat(true);
    };
...
StoryPlayButton.propTypes = {
    ...
    // changeChatClosePayload: PropTypes.func.isRequired,
...
const mapDispatchToProps = {
    ...
    // changeChatClosePayload: setChatClosePayload,
