        ...
        <>
            ...
            >
                <Dropdown.Menu className='first-column'>
                    ...
                    <Dropdown.Item onClick={() => onCreate('TablePayload')} data-cy='from-video-template'>Table</Dropdown.Item>
                    <Dropdown.Item onClick={() => onCreate('StarRatingPayload')} data-cy='from-qr-template'>Star Rating</Dropdown.Item>
                    <Dropdown.Item onClick={() => onCreate('LikeDislikePayload')} data-cy='from-qr-template'>Feedback</Dropdown.Item>
