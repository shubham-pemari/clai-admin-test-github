...
import {
    Menu, Icon, Dropdown, Popup, Message, Modal
...
class ProjectChat extends React.Component {
    ...
    render() {
        ...
        const {
            triggerChatPane, project: { _id: projectId }, initPayload, closePayload
        } = this.props;
        const chaticons = {
            marginLeft: "-18px"
        }
                        ...
                        <Menu.Item style={chaticons}>
                            <Popup
                                trigger={(
                                    ...
                                    //     disabled={noChannel}
                                    //     data-cy='set-custom-data'
                                    // />
                                )}
                                content='Set Custom Data'
...
const mapStateToProps = state => ({
    ...
    closePayload: state.settings.get('chatClosePayload'),
