...
export default class ErrorBoundary extends React.Component {
    ...
    isRootUrlError = () => {
        ...
        return false; //JG - commented out to check if it works without root url
    }
                    ...
                    <div>
                        ...
                        >
                            ...
                            <Header.Subheader style={{ marginTop: '10px' }}>
                                ...
                                the public URL where your instance of Clai Admin can be reached.
                            </Header.Subheader>
                        </Header>
                        {/* <p>
                            For more information visit the{' '}
                            <a href='https://clai-docs.pemari.com/installation/server-cluster#environment-variables'>
                                documentation
                            </a>
                        </p> */}
                    </div>
            ...
            <Container style={{ height: '100%', display: 'flex', alignItems: 'center' }}>
                <div>
                    ...
                    <p>
                        {reported
                            ? 'We\'re working on it!'
                            : 'Help the Clai Admin project by reporting the issue to Clai support.'}
                    </p>
                    {/* <p>
                        <CrashReportButton
                            pathname={pathname}
